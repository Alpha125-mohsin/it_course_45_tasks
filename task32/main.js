...
var newUsers = ["frank", "ALICE", "george", "BOB", "henry"];
var _loop_1 = function (newUser) {
    var normalizedNewUser = newUser.toLowerCase(); // Convert to lowercase
    if (currentUsers.some(function (currentUser) { return currentUser.toLowerCase() === normalizedNewUser; })) {
        console.log("Username '".concat(newUser, "' is already taken. Please choose another one."));
    }
    else {
