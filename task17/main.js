...
var guestList5 = ["Mohsin", "Ahsan", "Hamza", "ALi", "Umer"];
...
for (var _i = 0, guestList5_1 = guestList5; _i < guestList5_1.length; _i++) {
    var guest = guestList5_1[_i];
    console.log("Dear ".concat(guest, ", you are cordially invited to dinner. Please join me for an evening of good food and stimulating conversation."));
}
...
while (guestList5.length > 2) {
    var removedGuest = guestList5.pop(); // Remove the last guest
    console.log("Sorry, ".concat(removedGuest, ", we can't invite you to dinner."));
}
// Print invitation messages to the remaining guests
console.log("\nInvitations to the remaining guests:");
for (var _a = 0, guestList5_2 = guestList5; _a < guestList5_2.length; _a++) {
    var guest = guestList5_2[_a];
