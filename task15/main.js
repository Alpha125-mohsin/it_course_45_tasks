...
var guestList3 = ["Ahsan", "Hamza", "umer"];
// Print an invitation message to each guest
for (var i = 0; i < guestList3.length; i++) {
    console.log("Dear ".concat(guestList3[i], ", you are cordially invited to dinner. Please join me for an evening of good food and stimulating conversation."));
}
// Name of the guest who can't make it
var unableToAttend = guestList3[2]; // umer
console.log("".concat(unableToAttend, " regrets that they cannot make it to dinner."));
